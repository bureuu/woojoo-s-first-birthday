...
## Sprint 12.4 – Messages for Woojoo
- Added a Supabase-backed guestbook inside the “우주에게” letter.
- Guests can leave a nickname (1–12 chars) and a message (1–100 chars).
- Messages render safely with textContent and load newest-first in pages of 5.
- Added honeypot spam field, 15-second client cooldown, loading/error states, and mobile styling.
- Public browser credentials live in `guestbook-config.js`; never replace them with a service_role or secret key.
